    ...
    <div class="row justify-content-center">
        <div class="col">
            ...
            <form action="{{route('editNoteSubmit')}}" method="post">
                ...
                <div class="row mt-3">
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control bg-primary text-white" name="text_note" rows="5">{{old('text_note', $note->text)}}
                            </textarea>
                            @error('text_note')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                ...
                <div class="row mt-3">
                    <div class="col text-end">
                        <a href="{{route('home')}}" class="btn btn-primary px-5"><i class="fa-solid fa-ban me-2">
                            </i>Cancel</a>
